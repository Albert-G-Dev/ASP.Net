...
namespace LeaveApp
{
    public partial class leaveApp : System.Web.UI.Page
    {
        ...
        private void SaveLeaveApplicationToDatabase(string name, string email, string leaveType, string startDate, string endDate, string reason)
        {
            ...
            string query = "INSERT INTO LeaveApplicationForm (Name, Email, LeaveType, StartDate, EndDate, Reason) " +
            ...
            SendEmailNotification(name, email, leaveType, startDate, endDate, reason);

        }

                    private void SendEmailNotification(string name, string email, string leaveType, string startDate, string endDate, string reason)
                    {
                        try
                        {
                            ...
                            mail.Body = $"Hello {name},\n\n" +
                                        $"Your leave application has been submitted successfully. Here are the details:\n\n" +
